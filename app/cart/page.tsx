									...
									<form action="" className="pb-20">
										...
										<div className="">
											...
											<input
												...
												id="firstName"
												name="firstName"
												className="w-full border border-slate-300 p-3 rounded-lg mt-2"
											/>
										</div>
										<div className="mt-3">
						...
						<div className="border border-slate-200 rounded-xl p-8">
							...
							<div className="flex justify-between mt-5">
								...
								<h1 className="text-sm">
									{new Intl.NumberFormat("en-us", { style: "currency", currency: "PHP" }).format(total())}
								</h1>
							</div>
							<div className="flex justify-between mt-5">
							...
							{cart.length > 0 ? (
								<button
									className="w-full rounded-full bg-slate-900 text-white p-4 text-sm"
